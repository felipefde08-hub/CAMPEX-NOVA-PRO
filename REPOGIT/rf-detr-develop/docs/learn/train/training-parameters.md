...
| `eval_backend`               | `Literal["hotcoco","faster_coco_eval"]` | `"hotcoco"` | COCO evaluation backend for detection and segmentation mAP. Both ship with `rfdetr[train]` and return identical metrics; `"faster_coco_eval"` selects the previous, slower evaluator.                                                                                |
...
| `eval_backend`               | `Literal["hotcoco","faster_coco_eval"]` | "hotcoco"      | COCO evaluation backend; `"faster_coco_eval"` selects the previous, slower evaluator.                                                                                                                                     |
